...
public class DemoDataConfig {
    ...
    CommandLineRunner commandLineRunner(EventRepository eventRepository, AvailabilityRepository availabilityRepository) {
        return args -> {
            Event e1 = new Event("Move night", "Lets set a time to watch the movie tonight! When is everyone available?", "WIlliam", "will@hotmail.com");
            Event e2 = new Event("Team Meeting", "Hey team, lets set a time to meet tomorrow in preparation for the game this weekend.", "zhang", "zhang@hotmail.com");
            Event e3 = new Event("Fishing", "when can yall get up tmr?", "Jack Ma", "jackma@gmail.com");
